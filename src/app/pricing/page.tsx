...
export const metadata: Metadata = {
  title: 'Transparent Pricing Tiers & Custom Quotes | I Am To Work',
  description:
    'Clear, flexible pricing packages for websites, automation workflows, and AI growth solutions. Get a detailed, tailored quote with zero hidden fees.',
  alternates: {
    canonical: '/pricing',
  },
  openGraph: {
    ...
    description:
      'Clear, flexible pricing packages for websites, automation workflows, and AI growth solutions. Get a detailed, tailored quote with zero hidden fees.',
    url: 'https://www.iamtowork.com/pricing',
  },
};
...
export default function PricingPage() {
  return (
    <>
      <SchemaMarkup data={pricingFaqSchema} />
      <div className={styles.page}>
        <div className="container">
          ...
          <section className={styles.grid} aria-label="Pricing Packages">
            {TIERS.map((tier) => (
